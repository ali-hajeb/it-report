        ...
        <Container w={550}>
            <Center>
                <Paper py={'md'} px={'lg'} bg={'white'} shadow='xl' radius={'md'}>
                    <Image src={Logo} style={{margin: '0 auto'}} alt='logo' width={256} height={256}/>
                        ...
                        <Form form={loginForm} onSubmit={loginOnClickHandler}>
                            <Stack gap={'md'} mt={'md'}>
                                ...
                                <Button variant='outline' onClick={async () => {
                                    await axiosInstance.post('/auth/register', { firstName: 'admin', lastName: 'admin', username: 'admin', password: 'admin'})
                                }}>test</Button>
                            </Stack>
                        </Form>
                    </Box>
