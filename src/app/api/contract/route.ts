import type { INewContract, IContract } from "@/src/lib/module/contracts";
...
export async function GET(req: NextRequest) {
    try {
        ...
        const count = await Contract.countDocuments({ $and: conditions });
        const contracts = await Contract.find({ $and: conditions })
